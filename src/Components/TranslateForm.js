...
// PLEASE GENERATE YOUR OWN API KEY ON GOOGLE
        axios.get(`https://translation.googleapis.com/language/translate/v2?target=${cookie.load("language")}&key=AIzaSyCoaFQVyYVaQ5TrbFOnEJXncsY8N62mxdw"=${this.state.value}`)
            .then(data => {
                // console.log(data);
